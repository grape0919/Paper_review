...
영수증 이해. SROIE 데이터 세트를 사용하여 영수증 이해 작업을 평가합니다. 결과는 표 4에 나와 있습니다. SROIE에서 주요 정보 추출 작업의 성능 만 테스트하므로 잘못된 OCR 결과의 영향을 제거하려고합니다. 따라서 우리는 Ground Truth OCR을 사용하여 훈련 데이터를 전처리하고 LayoutLM 모델뿐만 아니라
